/* src/ThorsIOUtil/ThorsIOUtilConfig.h.  Generated from config.h.in by configure.  */
/* config.h.in.  Generated from configure.ac by autoheader.  */



#ifndef  THORS_IOUTIL_CONFIG_H
#define  THORS_IOUTIL_CONFIG_H
...
#define PACKAGE_STRING "ThorsIOUtil 3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thorsioutil"
...
/* Not all platforms support integers this large. So lets do an explicit test
   */
#define SUPPORT_SIGNED_INTEGER_LITERAL_THAT_IS_HUGE 1
...
/* Enable to use header only libraries */
#define THORS_IOUTIL_HEADER_ONLY 1

/* For header only convert to inline */
#define THORS_IOUTIL_HEADER_ONLY_INCLUDE inline

/* src/ThorsMongo/ThorsMongoConfig.h.  Generated from config.h.in by configure.  */
/* config.h.in.  Generated from configure.ac by autoheader.  */



#ifndef  THORS_THORSMONGO_CONFIG_H
#define  THORS_THORSMONGO_CONFIG_H
...
#define PACKAGE_STRING "ThorsMongo 0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thorsmongo"
...
/* Enable to use header only libraries */
#define THORS_MONGO_HEADER_ONLY 1

/* For header only convert to inline */
#define THORS_MONGO_HEADER_ONLY_INCLUDE inline

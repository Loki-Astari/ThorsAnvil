...
struct StarAdded
{
    ...
    StarItem                    item;
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"Event/StarAdded"}; return name;}
...
struct StarRemoved
{
    ...
    StarItem                    item;
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"Event/StarRemoved"}; return name;}

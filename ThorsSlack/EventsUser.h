...
struct UserChange
{
    ...
    std::time_t                 cache_ts;
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"UserChange"}; return name;}
...
struct UserConnection
{
    ...
    static std::string const& typeName() {static std::string const name{"UserConnection"}; return name;}
...
struct UserHuddleChanged
{
    ...
    std::time_t                 cache_ts;
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"UserHuddleChanged"}; return name;}

...
struct SharedChannelInviteAccepted
{
    ...
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"SharedChannelInviteAccepted"}; return name;}
...
struct SharedChannelInviteApproved
{
    ...
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"SharedChannelInviteApproved"}; return name;}
...
struct SharedChannelInviteDeclined
{
    ...
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"SharedChannelInviteDeclined"}; return name;}
...
struct SharedChannelInviteReceived
{
    ...
    SharedChannelInfo           channel;
    std::string                 event_ts;
    static std::string const& typeName() {static std::string const name{"SharedChannelInviteReceived"}; return name;}
...
struct SharedChannelInviteRequested
{
    ...
    VecSharedChannelTeam        teams_in_channel;
    static std::string const& typeName() {static std::string const name{"SharedChannelInviteRequested"}; return name;}

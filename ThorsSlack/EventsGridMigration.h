...
struct GridMigrationFinished
{
    ...
    static std::string const& typeName() {static std::string const name{"GridMigrationFinished"}; return name;}
...
struct GridMigrationStarted
{
    // std::string                 type;
    std::string                 enterprise_id;
    static std::string const& typeName() {static std::string const name{"GridMigrationStarted"}; return name;}

/* src/ThorsCrypto/ThorsCryptoConfig.h.  Generated from config.h.in by configure.  */
/* config.h.in.  Generated from configure.ac by autoheader.  */



#ifndef  THORS_CRYPTO_CONFIG_H
#define  THORS_CRYPTO_CONFIG_H
...
/* Name of package */
#define PACKAGE "thorscrypto"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "Loki.Astari+ThorsCrypto@gmail.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ThorsCrypto"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ThorsCrypto 3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thorscrypto"
...
/* Enable to use header only libraries */
#define THORS_CRYPTO_HEADER_ONLY 1

/* For header only convert to inline */
#define THORS_CRYPTO_HEADER_ONLY_INCLUDE inline
